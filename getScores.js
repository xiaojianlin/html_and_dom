function gapFilling() {
  ...
  gapFillingscore += contrastAnswer(document.getElementById('1_1').value,'统一建模语言',5);
  gapFillingscore += contrastAnswer(getElementById('1_2_1').value,'封装性',5);
  gapFillingscore += contrastAnswer(getElementById('1_2_2').value,'继承性',5);
  gapFillingscore += contrastAnswer(getElementById('1_2_3').value,'多态性',5);
...
function question() {
  var questionscore = 0;
  questionscore += contrastAnswer(document.getElementById('5').value,'模型是对现实世界的简化和抽象，模型是对所研究的系统、过程、事物或概念的一种表达形式；可以是某种图形；或者是一种数学表达式。',35);
